    ...
    <div class="title d-flex justify-content-between align-items-center">
      <div class="title_text">
        ...
        <ol class="breadcrumb mb-4">
          <li class="breadcrumb-item active">Manages Categories / View Categories</li>
        </ol>
      </div>
      <div>
        <a href="<?php echo BASE_URL ?>admin/links/categories/add.php" class="btn btn-primary">Create Categories</a>
      </div>
    </div>
    <!-- end of breadcrumb -->
